...
<h3>周复盘模板</h3>
<p>每周回看主线、行动、有效做法、暴露问题和下周重点。</p>
<div class="kb-badges">
<span class="kb-badge">模板</span>
<span class="kb-badge">有效</span>
</div>
</a>
<a class="kb-card" href="../templates/problem-template">
<h3>问题记录模板</h3>
<p>把一个真实问题从背景、尝试、判断和下一步完整记录下来。</p>
<div class="kb-badges">
<span class="kb-badge">问题库</span>
